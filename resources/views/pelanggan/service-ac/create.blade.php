...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('serviceAc.index') }}">Data Request Service Air Conditioner</a></li>
        <li class="breadcrumb-item">Request Service Air Conditioner</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('serviceAc.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" name="jumlah_service" class="form-control" min="0" value="0">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
