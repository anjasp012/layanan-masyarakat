...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Data Request Service Air Conditioner</li>
    </ol>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <table id="datatablesSimple" class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 8%">Nama Pemohon</th>
                            <th style="width: 10%">Nama Rumah Ibadah</th>
                            <th style="width: 15%">Alamat Rumah Ibadah</th>
                    ...
                    <tbody>
                        @foreach ($datas as $index => $data)
                            <tr>
                                ...
                                <td>
                                    {{ $data->ada_persediaan_tangga == 1 ? 'Ada' : 'Tidak Ada'}}
                                </td>
                                <td>
                                ...
                                <td>
                                    {{-- <a class="btn btn-warning btn-sm" href="{{ route('serviceAc.edit', $data->id) }}"><i class="fas fa-edit"></i></a> --}}
                                    <a class="btn btn-info btn-sm" href="{{ route('serviceAc.show', $data->id) }}"><i class="fas fa-info-circle"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
