...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('layanan.index') }}">Data Request Layanan</a></li>
        <li class="breadcrumb-item">Request Pengecatan</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_pemohon" id="nama_pemohon" class="form-control" value="{{ auth()->user()->nama_pengurus }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="nama_rumah_ibadah" class="form-label">Nama Rumah Ibadah</label>
                            <input type="text" name="nama_rumah_ibadah" id="nama_rumah_ibadah" class="form-control" value="{{ auth()->user()->nama_rumah_ibadah }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="alamat_rumah_ibadah" id="alamat_rumah_ibadah" class="form-control" value="{{ auth()->user()->alamat_lengkap_rumah_ibadah }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="tanggal_jam_pelaksanaan" class="form-label">Tanggal & Jam Pelaksanaan</label>
                            <input type="datetime-local" name="tanggal_jam_pelaksanaan" id="tanggal_jam_pelaksanaan" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea name="kolom_komentar" id="kolom_komentar" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="col-md-12">
            <form action="{{ route('layanan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="titik_lokasi_akurat_mobile" class="form-label">Titik lokasi akurat</label>
                            <div class="input-group">
                                <input type="text" name="titik_lokasi_akurat" id="titik_lokasi_akurat_mobile" class="form-control">
                                <button class="btn btn-outline-secondary" type="button" id="button-addon2" data-bs-toggle="modal" data-bs-target="#openLeaflet"><i class="fas fa-fw fa-street-view"></i></button>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script>
        ...
        var titikmobile = document.getElementById('titik_lokasi_akurat_mobile');
