...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('generalCleaning.index') }}">Data Request General Cleaning</a></li>
        <li class="breadcrumb-item">Request General Cleaning</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('generalCleaning.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
