...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('pengecatan.index') }}">Data Request Pengecatan</a></li>
        <li class="breadcrumb-item">Request Pengecatan</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('pengecatan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
