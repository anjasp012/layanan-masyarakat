...
@section('content')
    <h1 class="mt-4 text-capitalize">Daftar Dpd {{ strtolower($actived) }}</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item active text-capitalize">Daftar Dpd {{ strtolower($actived) }}</li>
    </ol>
    <div class="card mb-4">
        <div class="card-body">
            <table id="datatablesSimple" class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        @if (Request::routeIs('anggota.index') || Request::routeIs('dpp.index') || Request::routeIs('dpd.daerah') || Request::routeIs('relawan.index') || Request::routeIs('staff.index'))
                            <th style="width: 9%" class="text-center">No Kta</th>
                        @endif
                        @if (Request::routeIs('anggota.index'))
                            <th width="130px"class="text-center">Kepengurus</th>
                        @endif
                        @if (Request::routeIs('dpd.daerah') || Request::routeIs('dpd.index'))
                        ...
                        <tr>
                            ...
                            @if (Request::routeIs('dpd.daerah') || Request::routeIs('dpd.index'))
                                <td>
                                    ...
                                    @elseif (Request::routeIs('dpd.daerah'))
